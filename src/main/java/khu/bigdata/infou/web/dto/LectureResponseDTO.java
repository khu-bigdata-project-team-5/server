...
public class LectureResponseDTO {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class CategoryRecommandLectureInfo {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class CategoryRecommandLectureDto {

        List<CategoryRecommandLectureInfo> lectureList;
    }
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class HardCodingLectureInfo {
